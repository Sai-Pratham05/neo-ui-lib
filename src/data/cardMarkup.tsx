   ...
   <a href="" class="block cursor-pointer">
      <article class="w-full h-full">
         <figure class="w-full h-1/2 border-black border-b-2">
            <img
               src="https://neo-ui-lib.vercel.app/assets/neo-brutalism-image1.png"
               alt="thumbnail"
               class="w-full h-full object-cover"
               />
         </figure>
         <div class="px-6 py-5 text-left h-full">
            <p class="text-base mb-4">March 20th, 2025</p>
            <h1 class="text-[32px] mb-4">neo-ui-lib</h1>
            <p class="text-xs mb-4 line-clamp-4">
               Neo-ui-lib is an aesthetic characterized by high contrast
