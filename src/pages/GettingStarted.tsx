    ...
    <div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl mb-6">
          Transform your web design game with the{" "}
          <span className="font-bold">Neo-ui-lib</span> — your go-to toolkit
          for building bold, eye-catching webpages. Here's why it's a game
          changer!
        </h2>
        <div className="mb-8">
