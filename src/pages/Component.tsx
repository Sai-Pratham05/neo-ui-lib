        ...
        <>
          ...
          <div className="flex justify-end items-center mb-3 space-x-4">
            <div className="block cursor-pointer">
              <a
                href={`https://github.com/Sai-Pratham05/neo-ui-lib/blob/main/src/components/${displayingComponent.name}.tsx`}
                target="_blank"
              >
                <IconButton icon={githubIcon} color="red" />
              </a>
            </div>
            ...
            >
              <button className="flex items-center h-10 border-black border-2 p-2.5 bg-red-200 hover:bg-red-300 active:bg-yellow-400 hover:shadow-[2px_2px_0px_rgba(0,0,0,1)]">
