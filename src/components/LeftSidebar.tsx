  ...
  return componentsData.map((data, index) => {
    return (
      <div className="flex items-center mb-4 gap-2">
        ...
        {data.new && (
          <span className="text-xs bg-yellow-200 px-2 py-1 rounded">New</span>
        )}
      </div>
    );
  });
...
const LeftSidebar = () => {
  ...
  return (
    <section className="w-full flex">
      <div className="hidden md:block bg-pink-200 fixed top-20 left-0 w-[360px] h-screen overflow-y-scroll p-24">
